  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 mt-20">
        <h2 className={`${syne.className} text-2xl md:text-5xl lg:text-6xl mb-6 text-white max-w-4xl font-bold tracking-tight`}>
          Journey Highlights and updates
        </h2>
        <p className={`${inter.className} text-neutral-300 text-base md:text-lg max-w-2xl leading-relaxed font-light`}>
