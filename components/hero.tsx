  ...
  return (
    <div className="h-screen w-full relative flex flex-col items-start justify-center overflow-hidden px-4 sm:px-8 md:px-12 lg:px-16">
      <div className="top-6 relative z-10 max-w-[800px]">
        ...
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#8F8F8F] mb-8">
          Anish Ganapathi
        </h2>
        <p className="text-lg md:text-xl text-[#8F8F8F] max-w-3xl mb-8 leading-relaxed">
        ...
        <div className="flex gap-4">
          <Link href="/contact">
            <button className="px-8 py-3 rounded-full bg-white text-black font-medium hover:bg-gray-100 transition-colors hover:cursor-pointer">
              Contact
            </button>
          </Link>
          <Link href="/resume">
            <button className="px-8 py-3 rounded-full bg-[#1C1C1C] text-white font-medium border border-[#2A2A2A] hover:bg-[#2A2A2A] transition-colors hover:cursor-pointer">
              Resume
            </button>
          </Link>
        </div>
